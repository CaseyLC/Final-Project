...
namespace KomodoBadges
{
    public class KomodobadgesUI
    {
        ...
        {
            Komodobadges content = new Komodobadges();
        ...
        {
            Komodobadges badgeOne = new Komodobadges(73, new List<string> { "Door_7" });
            Komodobadges badgeTwo = new Komodobadges(84, new List<string> { "Door_3", "Door_2" });
